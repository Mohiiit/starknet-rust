            ...
            (Some(block_hash), Some(block_number), Some(state_root)) => {
                Ok(Self::Block(core::BlockWithTxHashes {
                    ...
                    l1_da_mode: match value.l1_da_mode {
                        core::L1DataAvailabilityMode::L1 => "L1".to_string(),
                        core::L1DataAvailabilityMode::L2 => "L2".to_string(),
                        core::L1DataAvailabilityMode::Calldata => "CALLDATA".to_string(),
                        core::L1DataAvailabilityMode::Blob => "BLOB".to_string(),
                    },
